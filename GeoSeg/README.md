...
Open the folder **master-ml-models** using **Linux Terminal** and create python environment:
...
*Notice: the commands are run from the root directory `master-ml-models`.*
...
The next section contains the original ReadMe contents from the underlying GeoSeg project. Thank you Dr. Libo Wang!
