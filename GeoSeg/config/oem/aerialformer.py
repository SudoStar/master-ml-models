...
weights_name = "aerialformer-swin-512crop-ms-epoch30-rep"
weights_path = "model_weights/aerialformer/{}".format(weights_name)
test_weights_name = weights_name
log_name = "aerialformer/{}".format(weights_name)
monitor = "val_mIoU"
monitor_mode = "max"
save_top_k = 1
save_last = True
